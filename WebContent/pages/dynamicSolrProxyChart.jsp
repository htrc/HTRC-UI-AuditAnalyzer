...
<html>
 <head>
    ...
    <title>Solr Proxy Realtime Usage</title>
    ...
    <body>
    <h1>Solr Proxy Realtime Usage</h1>

    <div id="placeholder" style="width:600px;height:300px;"></div>

    <p>Solr Proxy Realtime Usage Monitor</p>
...
$(function () {
   ...
   /* xmlhttp.onreadystatechange=function()
    ...
    xmlhttp.open("GET","solrProxyRealTime.action?",false);
    xmlhttp.send();
