...
# File:  SolrProxyAccessRealTimeMonitorAction.java
# Description: TODO
#
# -----------------------------------------------------------------
# 
...
public class SolrProxyAccessRealTimeMonitorAction extends ActionSupport{
...
*/
	...
	//	double access_count = 0; // number of access/second
		...
		//for (int i = 0; i < 3; i++) {
			...
			String line = "wc -l "
					+ HTRCLogConfig.SOLR_PROXY_LOG_HOME + "logfile";
